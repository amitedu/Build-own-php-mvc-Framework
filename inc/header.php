...
.menu a{text-decoration: none; background: #f2f2f2; border: 1px solid #999; color: #666;}
.search{float: right;}
.catSearch{border: 1px solid #ddd; font-size: 16px; margin-bottom: 5px; padding: 5px; cursor: pointer;}
